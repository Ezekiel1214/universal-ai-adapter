...
- fix(cli): sync metadata-driven help and version output (5d40904)

**Full Changelog**: https://github.com/Ezekiel1214/universal-ai-adapter/compare/v1.7.7...v1.7.8

## [1.7.7] - 2026-03-15

## What's Changed

- No user-facing changes were detected in this release window.

**Full Changelog**: https://github.com/Ezekiel1214/universal-ai-adapter/compare/v1.7.6...v1.7.7

## [1.7.6] - 2026-03-15

## What's Changed

- fix(ci): push release tags explicitly (38e89a7)

**Full Changelog**: https://github.com/Ezekiel1214/universal-ai-adapter/compare/v1.7.5...v1.7.6
